 ...
 *
 * The project byte cap closes the transfer-guard gap: without it, 256
...
export const INGEST_CAPS_V0 = {
  ...
  // 256 admits the canonical 66-book Bible and 114-surah Quran together.
  maxDocsPerProject: 256,
