...
export default defineConfig({
  ...
  projects: [
    ...
    {
      name: 'webkit-compact',
      testMatch: /(viewport|reader-modes|shortcuts|keyboard-navigation|compact-trends|compact-barcode|compact-concordance|compact-corpus|compact-vocabulary|compact-compare)\.spec\.ts/,
