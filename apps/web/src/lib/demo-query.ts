...
const DEMO_BY_SLUG: Readonly<Record<string, BuiltinCorpusId>> = Object.freeze({
  ...
  bible: BUILTIN_BIBLE_ID,
  quran: BUILTIN_QURAN_ID,
  koran: BUILTIN_QURAN_ID,
  arguments: BUILTIN_POLITICAL_ARGUMENTS_ID,
  political: BUILTIN_POLITICAL_ARGUMENTS_ID,
  shakespeare: BUILTIN_SHAKESPEARE_ID,
  inaugurals: BUILTIN_INAUGURALS_ID,
  darwin: BUILTIN_DARWIN_ORIGIN_ID,
  classics: BUILTIN_CLASSIC_NOVELS_ID,
