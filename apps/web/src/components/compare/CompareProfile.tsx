...
/** The one whole-comparison measurement sits centered in the two-sided profile. */
function DivergenceSummary({
  ...
  return (
    <tr
      className="compare-profile-row compare-divergence"
      data-metric="divergence"
      aria-label={`Vocabulary divergence between ${sideLabelA} and ${sideLabelB}`}
    >
      <td colSpan={3}>
        <span className="compare-divergence-content">
