          ...
          <>
            ...
            <div style={{ overflowX: 'auto' }}>
              <table aria-label="Corpus documents">
                <thead><tr><th scope="col">book</th><th scope="col">selected/full tokens</th><th scope="col">types</th><th scope="col">hapax</th><th scope="col">sentences</th><th scope="col">mean / median / p90</th><th scope="col">paragraph mean</th><th scope="col">TTR</th><th scope="col">MATTR</th><th scope="col">rhythm</th></tr></thead>
                <tbody>
                  {result.documents.map((row) => (
                    <tr key={row.doc}>
                      <th scope="row"><button type="button" onClick={() => setFocusedDoc(row.doc)} aria-pressed={focusedDoc === row.doc}>{titleByDoc.get(row.doc) ?? row.doc}</button></th>
