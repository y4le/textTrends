...
const WORKBENCH_HELP: Readonly<Record<Place, HelpCopy>> = Object.freeze({
  ...
  trends: {
    ...
    hint: 'Move through the trend to read exact positions; start and commit a range to compare that passage with the rest of the corpus. Double-click the graph to clear that range. On touch screens, double-tap the graph to clear that range.',
